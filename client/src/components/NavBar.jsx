        ...
        // <div>
            ...
            {/* <nav className="row navbar navbar-expand-sm"> */}
                <div className="container-fluid ps-4 pe-4 styled-text">
                    <Link  className="navbar-brand text-white pt-1" to={"/pirates"}>
                    <h1 className='h2 mb-0' style={{fontFamily : "Courier New, monospace"}}>Pirates of the Caribbean</h1>
                        ...
                        <li className="nav-item ps-2">
                            <div className="btn-group">
                                ...
                                <ul className="dropdown-menu" style={{backgroundColor : "#000"}}>
                                    <li><Link className="btn text-white" to={"/pirates/new"}><i className="bi bi-people-fill nav-icon"></i> Add Pirate </Link></li>
